...
is telling them.  To do this we use computational tools, software and HPC systems.  This module focuses on Statistical Computing, specifically R though we will
touch on SAS and you will have access to SAS University (free software and trainings).  Both softwares have their place in the field, one of the reasons we use
R is the price point (it's free) and SAS outside of universities is not.  SAS is used at many large firms, while R can be downloaded anywhere and used 
anywhere.  Exposure to both is a great thing, though R has a stronger usage and place in the field of data science.
